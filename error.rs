...
mod tests {
    ...
    fn test_valid_address() {
        let addr = "0x742d35Cc6634C0532925a3b8D39341Ce2E4bbF3B";
    ...
    fn test_invalid_address() {
        ...
        assert!(validate_address("742d35Cc6634C0532925a3b8D39341Ce2E4bbF3B").is_err());
        assert!(validate_address("0x742d35Cc6634C0532925a3b8D39341Ce2E4bbF3G").is_err());
    }
    ...
    fn test_invalid_tx_hash() {
        ...
        assert!(validate_tx_hash("1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef").is_err());
    }
    ...
    fn test_error_categories() {
        ...
        assert_eq!(EtherscanError::Api { message: "test".to_string(), result: None }.category(), "api");
    }

    #[test]
    fn test_retryable_errors() {
        assert!(EtherscanError::Request("test".to_string()).is_retryable());
        assert!(EtherscanError::Http { status: 500, message: "test".to_string() }.is_retryable());
        assert!(EtherscanError::RateLimit { retry_after: None, message: "test".to_string() }.is_retryable());
        assert!(!EtherscanError::MissingApiKey.is_retryable());
        assert!(!EtherscanError::InvalidAddress("test".to_string()).is_retryable());
    }
}