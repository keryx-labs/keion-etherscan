...
mod tests {
    ...
    #[test]
    fn test_transaction_value_eth() {
        let tx = Transaction {
            block_number: StringNumber::from(1000),
            block_hash: "0xabc".to_string(),
            transaction_index: StringNumber::from(0),
            hash: TxHash::new("0x123"),
            nonce: StringNumber::from(1),
            from: Address::new("0x742d35cc6634c0532925a3b8d19389c4d5e1e4a6"),
            to: Some(Address::new("0x742d35cc6634c0532925a3b8d19389c4d5e1e4a7")),
            value: BigNumber::from("1000000000000000000".to_string()), // 1 ETH
            gas: StringNumber::from(21000),
            gas_price: BigNumber::from("20000000000".to_string()), // 20 gwei
            gas_used: StringNumber::from(21000),
            cumulative_gas_used: StringNumber::from(21000),
            input: "0x".to_string(),
            timestamp: StringNumber::from(1640995200),
            method_id: None,
            function_name: None,
            receipt_status: Some(StringNumber::from(1)),
            confirmations: Some(StringNumber::from(10)),
            is_error: Some(StringNumber::from(0)),
        };

        assert_eq!(tx.value_eth(), Some(1.0));
    ...
    #[test]
    fn test_token_transfer_decimal_conversion() {
        let transfer = TokenTransfer {
            ...
            transaction_index: StringNumber::from(0),
            from: Address::new("0x742d35cc6634c0532925a3b8d19389c4d5e1e4a6"),
            to: Address::new("0x742d35cc6634c0532925a3b8d19389c4d5e1e4a7"),
            contract_address: Address::new("0xa0b86a33e6411b7a0a6acc95b0e8fd65b7b1b6c8"),
            value: BigNumber::from("1000000000000000000".to_string()), // 1 token with 18 decimals
            token_name: "Test Token".to_string(),
            token_symbol: "TEST".to_string(),
            token_decimal: StringNumber::from(18),
            gas_price: BigNumber::from("20000000000".to_string()),
            gas_used: StringNumber::from(50000),
            timestamp: StringNumber::from(1640995200),
            log_index: StringNumber::from(0),
            token_id: None,
            confirmations: Some(StringNumber::from(10)),
        };

        assert_eq!(transfer.decimal_value(), Some(1.0));
        assert!(!transfer.is_nft());
    }

    #[test]
    fn test_nft_transfer() {
        let nft_transfer = TokenTransfer {
            block_number: StringNumber::from(1000),
            block_hash: "0xabc".to_string(),
            hash: TxHash::new("0x123"),
            transaction_index: StringNumber::from(0),
            ...
            to: Address::new("0x742d35cc6634c0532925a3b8d19389c4d5e1e4a7"),
            contract_address: Address::new("0xa0b86a33e6411b7a0a6acc95b0e8fd65b7b1b6c8"),
            value: BigNumber::from("1".to_string()),
            token_name: "Test NFT".to_string(),
            token_symbol: "TNFT".to_string(),
            token_decimal: StringNumber::from(0),
            gas_price: BigNumber::from("20000000000".to_string()),
            gas_used: StringNumber::from(80000),
            timestamp: StringNumber::from(1640995200),
            log_index: StringNumber::from(0),
            token_id: Some(BigNumber::from("12345".to_string())),
            confirmations: Some(StringNumber::from(10)),
        };

        assert!(nft_transfer.is_nft());
        assert_eq!(nft_transfer.nft_token_id(), Some("12345"));
    }
}